                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            <div class="btn-group" role="group">
                                <a href="update-status.php?id=<?= $application['id'] ?>&status=reviewed" class="btn btn-success">Mark as Reviewed</a>
                                <a href="update-status.php?id=<?= $application['id'] ?>&status=approved" class="btn btn-primary">Approve Application</a>
                                <a href="update-status.php?id=<?= $application['id'] ?>&status=rejected" class="btn btn-danger">Reject Application</a>
                            </div>
                        </div>
                    </div>
                </div>
